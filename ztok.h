...
DEF(TOK_SNOT, 	 	"not",			TOK_FLOWS_MASK | 0x11)
DEF(TOK_SAND, 	 	"and",			TOK_FLOWS_MASK | 0x12)
DEF(TOK_SOR, 	 		"or",				TOK_FLOWS_MASK | 0x13)
#endif

#ifdef TOK_TYPES
DEF(TOK_VOID,    	"u0", 	  	TOK_TYPES_MASK 															| 0x20)
DEF(TOK_CHAR,    	"char",   	TOK_TYPES_MASK 															| 0x21)
DEF(TOK_F32,     	"f32",    	TOK_TYPES_MASK | TOK_FLOAT 									| 0x22)
DEF(TOK_F64,     	"f64",    	TOK_TYPES_MASK | TOK_FLOAT 									| 0x23)
DEF(TOK_I8,      	"i8",     	TOK_TYPES_MASK | TOK_SIGNED 								| 0x24)
DEF(TOK_I16,     	"i16",    	TOK_TYPES_MASK | TOK_SIGNED 								| 0x25)
DEF(TOK_I32,     	"i32",    	TOK_TYPES_MASK | TOK_SIGNED 								| 0x26)
DEF(TOK_I64,     	"i64",    	TOK_TYPES_MASK | TOK_SIGNED 								| 0x27)
DEF(TOK_U8,      	"u8",     	TOK_TYPES_MASK | TOK_UNSIGNED 							| 0x28)
DEF(TOK_U16,     	"u16",    	TOK_TYPES_MASK | TOK_UNSIGNED 							| 0x29)
DEF(TOK_U32,     	"u32",    	TOK_TYPES_MASK | TOK_UNSIGNED 							| 0x2A)
DEF(TOK_U64,     	"u64",    	TOK_TYPES_MASK | TOK_UNSIGNED 							| 0x2B)
DEF(TOK_STRUCT,  	"struct", 	TOK_TYPES_SIGNATURE_MASK | TOK_OVERRIDABLE 	| 0x2C)
DEF(TOK_UNION,   	"union",  	TOK_TYPES_SIGNATURE_MASK | TOK_OVERRIDABLE 	| 0x2D)
DEF(TOK_TYPEDEF, 	"type",  		TOK_TYPES_SIGNATURE_MASK 										| 0x2E)
DEF(TOK_ENUM,    	"enum",   	TOK_TYPES_SIGNATURE_MASK | TOK_OVERRIDABLE 	| 0x2F)
DEF(TOK_CONST,   	"const",  	TOK_TYPES_SIGNATURE_MASK 										| 0x30)
DEF(TOK_BOOL,   	"u1", 		 	TOK_TYPES_SIGNATURE_MASK 										| 0x31)
#endif
...
DEF(TOK_COMMA,     		",",   	TOK_SYMBOLS_MASK | 0x64)
DEF(TOK_EQ,        		"=",   	TOK_SYMBOLS_MASK | 0x65)
DEF(TOK_DOT,       		".",   	TOK_SYMBOLS_MASK | 0x66)
