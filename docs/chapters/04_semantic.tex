...
\umlfig{07_semantic}{Class diagram: the semantic analysis structures (symbol tables, scopes, capabilities).}{fig:semantic}
...
The type system is built around the \texttt{ZType} value shown in Figure~\ref{fig:types}.

\umlfig{01_types}{Class diagram: the type system (\texttt{ZType}).}{fig:types}
