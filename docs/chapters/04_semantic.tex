...
Comparison and logical operators (\zn{==}, \zn{!=}, \zn{<}, \zn{>}, \zn{<=}, \zn{>=}, \zn{and}, \zn{or}) always yield \zn{u1}. Assignment (\zm{=}) requires the LHS to be an lvalue (identifier, subscript, member or pointer dereference) and yields the LHS type.
...
\sectino{Struct, Enum and Embedding Checks}
