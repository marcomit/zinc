...
The \texttt{ZNode} variants are grouped into four families. Helper nodes
(Figure~\ref{fig:ast-helpers}), statements and control flow
(Figure~\ref{fig:ast-statements}), expressions
(Figure~\ref{fig:ast-expressions}) and declarations and literals
(Figure~\ref{fig:ast-declarations}).

\umlfig{03_ast_helpers}{Class diagram: AST helper nodes.}{fig:ast-helpers}

\umlfig{04_ast_statements}{Class diagram: AST statements and control flow.}{fig:ast-statements}

\umlfig{05_ast_expressions}{Class diagram: AST expressions.}{fig:ast-expressions}

\umlfig{06_ast_declarations}{Class diagram: AST declarations and literals.}{fig:ast-declarations}
...
\umlfig{08_parser}{Class diagram: the parser (\texttt{ZParser}) and its entry points.}{fig:parser}
