...
#define TOK_OVERRIDABLE                 (1 << (TOK_BASE_MASK + 0x0C))
#endif                                  
...
DEF(TOK_STAR,           "*",            TOK_OPERATOR | TOK_OVERRIDABLE  | TOK_SYMBOLS_MASK | 0x5D)
DEF(TOK_PLUS,           "+",            TOK_OPERATOR | TOK_OVERRIDABLE  | TOK_SYMBOLS_MASK | 0x60)
DEF(TOK_MINUS,          "-",            TOK_OPERATOR | TOK_OVERRIDABLE  | TOK_SYMBOLS_MASK | 0x61)
DEF(TOK_DIV,            "/",            TOK_OPERATOR | TOK_OVERRIDABLE  | TOK_SYMBOLS_MASK | 0x62)
DEF(TOK_COMMA,          ",",            TOK_SYMBOLS_MASK | TOK_EXPANDABLE | 0x64)
DEF(TOK_EQ,             "=",            TOK_SYMBOLS_MASK | TOK_EXPANDABLE | 0x65)
