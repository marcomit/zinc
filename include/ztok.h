...
#define TOK_DYN_MASK                    (1 << (TOK_BASE_MASK + 0x02))
#define TOK_SYMBOLS_MASK                (1 << (TOK_BASE_MASK + 0x03))
#define TOK_OPERATOR                    (1 << (TOK_BASE_MASK + 0x04))
#define TOK_TYPES_SIGNATURE_MASK        (1 << (TOK_BASE_MASK + 0x05))
#define TOK_LITERAL                     (1 << (TOK_BASE_MASK + 0x06))
#define TOK_SIGNED                      (1 << (TOK_BASE_MASK + 0x07))
#define TOK_UNSIGNED                    (1 << (TOK_BASE_MASK + 0x08))
#define TOK_FLOAT                       (1 << (TOK_BASE_MASK + 0x09))
...
DEF(TOK_CONTINUE,   "continue",         TOK_FLOWS_MASK | TOK_EXPANDABLE | 0x03)
DEF(TOK_BREAK,      "break",            TOK_FLOWS_MASK | TOK_EXPANDABLE | 0x04)
DEF(TOK_RETURN,     "return",           TOK_FLOWS_MASK | TOK_EXPANDABLE | 0x05)
DEF(TOK_SWITCH,     "switch",           TOK_FLOWS_MASK | TOK_EXPANDABLE | 0x07)
DEF(TOK_CASE,       "case",             TOK_FLOWS_MASK | TOK_EXPANDABLE | 0x08)
DEF(TOK_MODULE,     "use",              TOK_FLOWS_MASK | TOK_EXPANDABLE | 0x09)
DEF(TOK_FOREIGN,    "foreign",          TOK_FLOWS_MASK | TOK_EXPANDABLE | 0x0A)
DEF(TOK_DEFER,      "defer",            TOK_FLOWS_MASK | TOK_EXPANDABLE | 0x0B)
DEF(TOK_IN,         "in",               TOK_FLOWS_MASK | TOK_EXPANDABLE | 0x0C)
DEF(TOK_MATCH,      "match",            TOK_FLOWS_MASK | TOK_EXPANDABLE | 0x0D)
...
DEF(TOK_CAST,       "as",               TOK_FLOWS_MASK | TOK_EXPANDABLE | TOK_OVERLOADABLE | 0x15)
...
DEF(TOK_STRUCT,     "struct",           TOK_TYPES_SIGNATURE_MASK | TOK_EXPANDABLE   | 0x2D)
...
DEF(TOK_IDENT,      "identifier",       TOK_DYN_MASK | TOK_EXPANDABLE                   | 0x44)
DEF(TOK_RUNE_LIT,   "rune literal",     TOK_DYN_MASK | TOK_LITERAL | TOK_EXPANDABLE     | 0x45)
#endif

#ifdef TOK_SYMBOLS
DEF(TOK_ARROW,          "->",           TOK_SYMBOLS_MASK | 0x50)
DEF(TOK_EQEQ,           "==",           TOK_SYMBOLS_MASK | TOK_OVERLOADABLE | 0x51)
DEF(TOK_NOTEQ,          "!=",           TOK_SYMBOLS_MASK | 0x52)
DEF(TOK_ASSIGN,         ":=",           TOK_SYMBOLS_MASK | 0x55)
DEF(TOK_DOUBLE_COLON,   "::",           TOK_SYMBOLS_MASK | 0x73)
DEF(TOK_TRIPLE_DOT,     "...",          TOK_SYMBOLS_MASK | 0x74)
DEF(TOK_COALESCING,     "??",           TOK_SYMBOLS_MASK | 0x79)
...
DEF(TOK_DIV,            "/",            TOK_OPERATOR | TOK_OVERLOADABLE     | TOK_SYMBOLS_MASK | 0x62)
DEF(TOK_COMMA,          ",",            TOK_SYMBOLS_MASK | TOK_EXPANDABLE   | 0x64)
DEF(TOK_EQ,             "=",            TOK_SYMBOLS_MASK | TOK_OVERLOADABLE |TOK_EXPANDABLE | 0x65)
DEF(TOK_DOT,            ".",            TOK_SYMBOLS_MASK | TOK_EXPANDABLE | 0x66)
DEF(TOK_BITL,           "<<",           TOK_SYMBOLS_MASK | TOK_BITOPERATOR_MASK | 0x71)
DEF(TOK_BITR,           ">>",           TOK_SYMBOLS_MASK | TOK_BITOPERATOR_MASK | 0x72)
DEF(TOK_BITOR,          "|",            TOK_SYMBOLS_MASK | TOK_BITOPERATOR_MASK | 0x76)
DEF(TOK_BITNOT,         "~",            TOK_SYMBOLS_MASK | TOK_BITOPERATOR_MASK | 0x75)
DEF(TOK_BITXOR,         "^",            TOK_SYMBOLS_MASK | TOK_BITOPERATOR_MASK | 0x77)
DEF(TOK_GTE,            ">=",           TOK_SYMBOLS_MASK | TOK_OVERLOADABLE     | 0x67)
DEF(TOK_LTE,            "<=",           TOK_SYMBOLS_MASK | TOK_OVERLOADABLE     | 0x68)
DEF(TOK_GT,             ">",            TOK_SYMBOLS_MASK | TOK_OVERLOADABLE     | 0x69)
DEF(TOK_LT,             "<",            TOK_SYMBOLS_MASK | TOK_OVERLOADABLE     | 0x6A)
DEF(TOK_SEMICOLON,      ";",            TOK_SYMBOLS_MASK | TOK_EXPANDABLE | 0x6B)
DEF(TOK_COLON,          ":",            TOK_SYMBOLS_MASK | TOK_EXPANDABLE | 0x6C)
