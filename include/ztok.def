...
#define TOK_SELF_OPERATOR               (1 << (TOK_BASE_MASK + 0x0D))
#endif
...
DEF(TOK_LARROW,         "<-",           TOK_SYMBOLS_MASK | 0x84)
...
DEF(TOK_SELF_PLUS,      "+=",           TOK_SYMBOLS_MASK | TOK_SELF_OPERATOR | 0x7B)
DEF(TOK_SELF_MINUS,     "-=",           TOK_SYMBOLS_MASK | TOK_SELF_OPERATOR | 0x7C)
DEF(TOK_SELF_MUL,       "*=",           TOK_SYMBOLS_MASK | TOK_SELF_OPERATOR | 0x7D)
DEF(TOK_SELF_DIV,       "/=",           TOK_SYMBOLS_MASK | TOK_SELF_OPERATOR | 0x7E)
DEF(TOK_SELF_BITOR,     "|=",           TOK_SYMBOLS_MASK | TOK_SELF_OPERATOR | 0x7F)
DEF(TOK_SELF_BITAND,    "&=",           TOK_SYMBOLS_MASK | TOK_SELF_OPERATOR | 0x80)
DEF(TOK_SELF_BITXOR,    "^=",           TOK_SYMBOLS_MASK | TOK_SELF_OPERATOR | 0x81)
DEF(TOK_SELF_BITL,      "<<=",          TOK_SYMBOLS_MASK | TOK_SELF_OPERATOR | 0x82)
DEF(TOK_SELF_BITR,      ">>=",          TOK_SYMBOLS_MASK | TOK_SELF_OPERATOR | 0x83)
